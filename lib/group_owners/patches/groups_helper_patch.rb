  ...
  module Patches
    module GroupsHelperPatch
      def self.included(base) # :nodoc:
        ...
        base.class_eval do
          alias_method :group_settings_tabs_without_owner, :group_settings_tabs
          alias_method :group_settings_tabs, :group_settings_tabs_with_owner

          alias_method :render_principals_for_new_group_users_without_owner, :render_principals_for_new_group_users
          alias_method :render_principals_for_new_group_users, :render_principals_for_new_group_users_with_owner
        end
      end
