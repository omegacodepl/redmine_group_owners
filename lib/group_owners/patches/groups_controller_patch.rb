  ...
  module Patches
    module GroupsControllerPatch
      def self.included(base)
        ...
        base.class_eval do
          skip_before_action :require_admin, :only => [:index, :show, :new, :create, :edit, :update, :new_users, :add_users, :remove_user, :autocomplete_for_user]
          before_action :require_admin_or_owner, :only => [:index, :show, :new, :create, :edit, :update, :new_users, :add_users, :remove_user, :autocomplete_for_user]
          before_action -> {params.permit!}
          layout :set_layout



          alias_method :index_without_owner, :index
          alias_method :index, :index_with_owner

          alias_method :create_without_owner, :create
          alias_method :create, :create_with_owner

          alias_method :update_without_owner, :update
          alias_method :update, :update_with_owner
        end
      end
